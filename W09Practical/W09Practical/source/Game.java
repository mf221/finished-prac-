    ...
    public void play() {
        ...
        do {
            ...
            if (pos1 != pos2 && checkValidInput(pos1) && checkValidInput(pos2)){
                if (isBlackTurn && isBlackMoveMustTake(pos1, pos2)) {
                    if(gameBoard.isPieceBlack(gameBoard.getColIndex(pos1), gameBoard.getRowIndex(pos1))){
                        if(checkForKing(pos1, gameBoard.getBlackMan())|| gameBoard.isKing(gameBoard.getColIndex(pos1), gameBoard.getRowIndex(pos1))){
                            ...
                            if(gameBoard.checkCanTake(gameBoard.getColIndex(pos1), gameBoard.getRowIndex(pos1),
                               gameBoard.getColIndex(pos2), gameBoard.getRowIndex(pos2), gameBoard.getBlackKing())){
                                play();
                            }   
                        }
                            ...
                            if(gameBoard.checkCanTake(gameBoard.getColIndex(pos1), gameBoard.getRowIndex(pos1),
                               gameBoard.getColIndex(pos2), gameBoard.getRowIndex(pos2), gameBoard.getBlackMan())){
                                play();
                            }
                    }
                        else {
                ...
                else if(isWhiteMoveMustTake(pos1, pos2)){ //white turn
                    if(gameBoard.isPieceWhite(gameBoard.getColIndex(pos1), gameBoard.getRowIndex(pos1))){
                        if(checkForKing(pos1, gameBoard.getWhiteMan())|| gameBoard.isKing(gameBoard.getColIndex(pos1), gameBoard.getRowIndex(pos1))){
                            ...
                            if(gameBoard.checkCanTake(gameBoard.getColIndex(pos1), gameBoard.getRowIndex(pos1),
                               gameBoard.getColIndex(pos2), gameBoard.getRowIndex(pos2), gameBoard.getWhiteKing())){
                               play();
                            }    
                        }
                                ...
                                if(gameBoard.checkCanTake(gameBoard.getColIndex(pos1), gameBoard.getRowIndex(pos1),
                                  gameBoard.getColIndex(pos2), gameBoard.getRowIndex(pos2), gameBoard.getWhiteMan())){
                                  play();
                            }
                        }                     
                        else {
